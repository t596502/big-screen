<template>
    <div class="order-map">
        ...
        <VueNextEcharts :options="options" v-else></VueNextEcharts>
    </div>
</template>
...
<script>
    ...
    import VueNextEcharts from '/@/components/VueNextEcharts/index.vue'

    export default {
        name: "OrderMap",
        components: {VueNextEcharts},
        setup(props) {
            ...
            const update = () => {
                fetch('http://www.youbaobao.xyz/datav-res/datav/map.json')
                    ...
                    .then(data => {
                        ...
                        console.log('2', convertData(mapData[0]), convertToLineData(mapData[0], geoGpsMap[1]));
